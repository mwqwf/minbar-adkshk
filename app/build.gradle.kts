...
android {
    ...
    defaultConfig {
        ...
        // ٣٢ / ٢.٧.٢ — حمايةُ ملفّات حزم المتجر من الحذف: كانت «حذف التنزيل»
        // و«حذف الكل» وكنّاسُ اليتامى تحذف ملفّاً يملكه Play، فتُفسد الحزمة
        // صامتةً ولا يعلم المتجر أنها نقصت. الآن يُسقط قيدُها من الفهرس وحسب،
        // والإزالةُ الصحيحة `removePack` وحدها.
        // ٣٣ / ٢.٧.٣ — لا تنزيلَ مرّتين، وعطلا أندرويد ٦. حزمتا `fast-follow`
        // تصلان بعد التثبيت بمدّة يقرّرها المتجر بينما يكتمل الكتالوج في ثوانٍ،
        // فكان محرّك الأولوية يسحب المكتبة من R2 في ما بين ذلك ثمّ تصل الحزم
        // بالصوت نفسه: شبكةٌ ومساحةٌ مرّتين. وصار ما يُنتظر من المتجر مؤجَّلاً.
        // وعلى أندرويد ٦: `restrictBackgroundStatus` (API 24) بلا حارس كانت
        ...
        // ٣٥ / ٢.٧.٥ — أيقوناتٌ تتّجه مع العربية. «أرسل» و«تراجع» و«كتم الصوت»
        // وأيقونة المصحف والمحادثة كانت بنسخها المهملة التي لا تنعكس من اليمين
        // إلى اليسار، فتشير «أرسل» إلى الخلف. صارت بنسخها المنعكسة، وأُبدلت
