...
data class NotificationItem(
    ...
    val createdAtMs: Long,
    /**
     * ⚠️ وجهةُ الإشعار كما أرسلها الخادم — تُقرأ من خريطة `data` المحفوظة مع
     * الوثيقة.
     *
     * بلا هذين الحقلين كان الإشعار الواحد يفتح وجهتين مختلفتين: نقرُه من
     * شريط النظام يفتح الدرس المنشور (لأنّ المستقبِل يقرأ `data` كاملةً)،
     * ونقرُه من شاشة «الإشعارات» يفتح شاشةً أخرى — لأنّ القائمة كانت تُسقط
     * `data` وتكتفي بـ`type`. فمن مسح إشعار النظام لا يجد طريقاً إلى ما
     * أُعلم به أصلاً.
     */
    val lessonId: String = "",
    val route: String = "",
