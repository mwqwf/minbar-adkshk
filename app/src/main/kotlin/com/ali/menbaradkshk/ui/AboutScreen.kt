        ...
        Card(
            ...
            Text(
                "منصّة تحفظ إرث مشايخ ادكصهك وتوفّر لهم منبرًا لنشر صوتياتهم " +
                    ...
                    "عاصم وورش عن نافع وقالون عن نافع — بنصّ كل رواية برسم مصحفها، " +
                    "وفهرسة بالسور والأجزاء والأحزاب والصفحات، وأكثر من ستّين قارئًا " +
                    "تُضاء الآية الجارية مع تلاوتهم، مع تنزيل السورة أو المصحف كاملًا " +
                    "للاستماع دون إنترنت، ونسخ الآيات ومشاركتها، وحفظ موضع القراءة. " +
                    "ونصّ المصحف نفسه داخل التطبيق يعمل دون إنترنت دائمًا.\n\n" +
                    "ومعه صفحة «الأذكار»: أذكار الصباح والمساء ومجموعات مواضيعية " +
                    "بتخريجها وفضلها، بعدّاد يومي وتذكيرات لطيفة، وتكبير للخطّ يصل " +
                    "إلى أضعاف حجمه لكبار السنّ — تعمل كاملةً دون إنترنت.",
