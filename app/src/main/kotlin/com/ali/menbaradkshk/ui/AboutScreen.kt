        ...
        Card(
            ...
            Text(
                "منصّة تحفظ إرث مشايخ ادكصهك وتوفّر لهم منبرًا لنشر صوتياتهم " +
                    ...
                    "وهو مبنيٌّ على أنّ إنترنتك قد يضعف أو ينقطع: لا يُنزّل من " +
                    "المحتوى إلا ما استجدّ منه، ويسألك عند أوّل تشغيل عن قسمك " +
                    "الذي تتابعه ليحفظ دروسه على هاتفك تلقائيًا حين تتصل " +
                    "بواي فاي. وإن انقطع الإنترنت ظهر لك «أظهر المحفوظ فقط» " +
                    "فلا ترى إلا ما يعمل عندك فعلًا. وللدرس المحفوظ «أرسل " +
                    "الملف الصوتي» فينتقل بالبلوتوث إلى من بجوارك بلا شبكة.\n\n" +
