        ...
        Card(
            ...
            Text(
                "منصّة تحفظ إرث مشايخ ادكصهك وتوفّر لهم منبرًا لنشر صوتياتهم " +
                    ...
                    "إنترنت، بلا حساب وبأقل بيانات. ومعها صفحة «الأذكار»: أذكار " +
                    "الصباح والمساء ومجموعات مواضيعية بتخريجها وفضلها، بعدّاد " +
                    "يومي وتذكيرات لطيفة — تعمل كاملةً دون إنترنت.",
